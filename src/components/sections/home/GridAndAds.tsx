...
import ads from '../../../../public/images/ads-1.webp';
    ...
    <section className='pb-12 text-gray-800 sm:px-6 lg:px-8'>
        <div className='flex flex-col lg:flex-row lg:space-x-8'>
            <div className='w-full lg:w-10/12 mb-8 lg:mb-0'>
                ...
                {
                    articles.map((article)=>( <ArticleCardGrid key={article._id} article={article}/>))
                }
                </div>
            </div>
            <div className='w-full lg:w-2/12 flex justify-center items-center lg:block'>
                <Link href='/'>
                    <Image src={ads} alt="ads" width={300} height={300} loading='lazy' className='w-full h-auto object-cover'/>
                </Link>
            </div>
        </div>
    </section>
